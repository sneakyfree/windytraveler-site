...
const plans = [
  ...
  },
  {
    ...
    features: ['Unlimited offline packs', 'All 209 languages', 'Full AI concierge', 'Priority everything', 'Clone voice translation', 'Booking integration', 'One regional pack included'],
