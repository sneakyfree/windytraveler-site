...
const faqs = [
  ...
  { q: 'What\'s the difference between subscriptions and bundles?', a: 'Subscriptions (Day Pass, Trip Pack, Annual, Premium) give you the full travel service — AI guides, deals, booking, temporary language access. Bundles are regional packs of translation models you own outright: The Grand Tour for Europe, The Safari for Africa, The Silk Road, The Dragon, The Archipelago, The Explorer — or Marco Polo\'s Magic Box for every language at once. Buy a bundle once, own it forever. They work great together but either works standalone.' },
  ...
  { q: 'Is my travel data private?', a: 'Absolutely. In local mode, translation happens entirely on your device — nothing touches any server. If you opt into cloud features, everything is end-to-end encrypted via WindyCloud. We don\'t sell your data, train on your conversations, or share your location. You control what stays local and what syncs.' },
];
